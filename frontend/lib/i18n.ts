...
const resources = {
  en: {
    translation: {
      ...
      "settings.tokenBalance": "Token Balance",
      ...
      "profile.redeemTitle": "Redeem Activation Code",
      "profile.redeemSubtitle": "Enter your code to add tokens to your balance.",
      "profile.enterCode": "Enter code here",
      "profile.redeem": "Redeem",
      "profile.redeemSuccess": "Successfully added {{tokens}} tokens!",
      "profile.redeemCode": "Redeem Code",
      "profile.redeemError.invalid": "Invalid activation code",
      "profile.redeemError.used": "This code has already been used or expired",
      "profile.redeemError.generic": "Failed to redeem code",
      // Tabs
      "tabs.home": "Home",
      "tabs.tools": "Toolbox",
  ...
  "manualEntry.deleteConfirmation": "Are you sure you want to delete this learning record?",
      ...
      "settings.apiServer.title": "API Server",
      "settings.apiServer.description": "Switch backend environment without rebuild",
      ...
      "settings.learning.defaultMode": "Default Learning Mode",
      "settings.learning.defaultModeDesc": "Choose how you want to learn by default",
      "settings.learning.modeListenOnly": "Listen Only",
      "settings.learning.modeListenRepeat": "Listen & Repeat",
      "settings.learning.maxAttempts": "Practice Attempts",
      "settings.learning.maxAttemptsDesc": "Maximum attempts allowed for each sentence",
      ...
      // Agents feature
      "agents.title": "Personal Tutor",
      "agents.description": "Ask questions about learning English anytime",
      "agents.noAgents": "No Personal Tutor available at the moment.",
      "agents.offlineError": "Personal Tutor feature requires an internet connection. Please check your network settings.",
      "chat.placeholder": "Type a message...",
      "chat.loginRequired": "Please login to chat with Personal Tutor.",
      ...
      "chat.insufficientTokens": "Insufficient tokens. Please recharge.",
      ...
      "pronunciation.tryAgain": "Nice try",
      ...
      // Tests
      "tests.title": "Language Proficiency Tests",
      "tests.description": "Evaluate your proficiency",
      "tests.strategy.linear": "Standard",
      "tests.strategy.adaptive": "Adaptive",
      "tests.empty": "No tests available at the moment.",
      "tests.loading": "Preparing your test...",
      "tests.result.title": "Test Completed!",
      "tests.result.score": "Your Score",
      "tests.result.passed": "Passed",
      "tests.result.failed": "Keep Practicing",
      "tests.result.back": "Back to Tests",
      "tests.result.skills": "Skill Breakdown",
      "tests.result.showLevels": "See all levels",
      "tests.result.hideLevels": "Hide all levels",
      "tests.result.yourLevel": "Your Level",
      "tests.submit": "Submit Answer",
      "tests.error.generic": "Something went wrong.",
      "tests.error.start": "Failed to start test. Please try again.",
      "tests.error.submit": "Failed to submit answer. Please try again.",
      "tests.questionnaire.title": "Questionnaire",
      "tests.questionnaire.submit": "Submit",
      "tests.questionnaire.next": "Next",
      "tests.questionnaire.previous": "Previous",
      "tests.question.fillBlank": "Fill in the blanks",
      "tests.question.multipleChoice": "Select the correct answer",
      "tests.question.matching": "Match the following",
      "tests.question.listening": "Listen and answer",
      "tests.question.reading": "Read and answer",
      "tests.question.speaking": "Speak the answer",
      "tests.question.typePlaceholder": "Type your answer here...",
      "tests.question.tapToSpeak": "Tap to Speak",
      "tests.question.tapToRecord": "Tap to Record",
      "tests.question.tapToStop": "Tap to Stop",
      "tests.question.recording": "Recording...",
      "tests.question.play": "Play",
      "tests.question.stop": "Stop",
      "tests.question.rerecord": "Re-record",
      "tests.question.confirmUpload": "Confirm & Upload",
      "tests.question.uploading": "Uploading...",
      "tests.question.uploaded": "Recorded",
      "tests.question.speakInstruction": "Tap the microphone and speak.",
      "tests.question.listeningStatus": "Listening...",
      "tests.question.processingStatus": "Processing...",
      "tests.question.tryAgain": "Try Again",
      "tests.history.title": "Test History",
      "tests.history.empty": "No test history found.",
      "tests.next": "Next",
    },
  },
  zh: {
    translation: {
      ...
      "settings.tokenBalance": "Token余额",
      "profile.title": "个人信息",
      "profile.noEmail": "无",
      "profile.noDisplayName": "无",
      "profile.displayName": "昵称",
      "profile.email": "邮箱",
      "profile.tokenBalance": "Token余额",
      "profile.notSet": "未设置",
      ...
      "profile.redeemTitle": "兑换激活码",
      "profile.redeemSubtitle": "输入激活码以增加您的Token余额。",
      "profile.enterCode": "在此输入激活码",
      "profile.redeem": "兑换",
      "profile.redeemSuccess": "成功增加 {{tokens}} Token！",
      "profile.redeemCode": "兑换码",
      "profile.redeemError.invalid": "无效的激活码",
      "profile.redeemError.used": "该激活码已被使用或已过期",
      "profile.redeemError.generic": "兑换失败",
      // Tabs
      "tabs.home": "首页",
      "tabs.tools": "工具",
      "tabs.progress": "记录",
  ...
  "manualEntry.deleteConfirmation": "确定要删除这条学习记录吗？",
      ...
      "settings.apiServer.title": "API 服务器",
      "settings.apiServer.description": "无需重建即可切换后端环境",
      ...
      "settings.learning.defaultMode": "默认学习模式",
      "settings.learning.defaultModeDesc": "选择您默认的学习方式",
      "settings.learning.modeListenOnly": "仅听",
      "settings.learning.modeListenRepeat": "听并跟读",
      "settings.learning.maxAttempts": "练习次数",
      "settings.learning.maxAttemptsDesc": "每句话允许的最大练习次数",
      ...
      // Agents feature
      "agents.title": "随身老师",
      "agents.description": "学英语的问题，随时来问",
      "agents.noAgents": "暂时没有可用的随身老师。",
      "agents.offlineError": "随身老师功能需要互联网连接。请检查您的网络设置。",
      "chat.placeholder": "输入消息...",
      "chat.loginRequired": "请登录后与随身老师聊天。",
      ...
      "chat.insufficientTokens": "Token不足，请充值。",
      ...
      "pronunciation.tryAgain": "不错，继续加油",
      ...
      // Tests
      "tests.title": "语言能力测试",
      "tests.description": "评估您的语言水平",
      "tests.strategy.linear": "标准",
      "tests.strategy.adaptive": "自适应",
      "tests.empty": "暂时没有可用的测试。",
      "tests.loading": "正在准备测试...",
      "tests.result.title": "测试完成！",
      "tests.result.score": "你的得分",
      "tests.result.passed": "通过",
      "tests.result.failed": "继续练习",
      "tests.result.back": "返回测试列表",
      "tests.result.skills": "技能分析",
      "tests.result.showLevels": "查看所有等级",
      "tests.result.hideLevels": "收起等级列表",
      "tests.result.yourLevel": "当前等级",
      "tests.submit": "提交答案",
      "tests.error.generic": "出错了。",
      "tests.error.start": "无法开始测试，请重试。",
      "tests.error.submit": "提交答案失败，请重试。",
      "tests.questionnaire.title": "问卷",
      "tests.questionnaire.submit": "提交",
      "tests.questionnaire.next": "下一步",
      "tests.questionnaire.previous": "上一题",
      "tests.question.fillBlank": "填空",
      "tests.question.multipleChoice": "选择正确答案",
      "tests.question.matching": "配对",
      "tests.question.listening": "听力回答",
      "tests.question.reading": "阅读回答",
      "tests.question.speaking": "口语回答",
      "tests.question.typePlaceholder": "在此输入答案...",
      "tests.question.tapToSpeak": "点击说话",
      "tests.question.tapToRecord": "点击录音",
      "tests.question.tapToStop": "点击停止",
      "tests.question.recording": "录音中...",
      "tests.question.play": "播放",
      "tests.question.stop": "停止",
      "tests.question.rerecord": "重新录制",
      "tests.question.confirmUpload": "确认并上传",
      "tests.question.uploading": "上传中...",
      "tests.question.uploaded": "已录制",
      "tests.question.speakInstruction": "点击麦克风开始说话。",
      "tests.question.listeningStatus": "正在听...",
      "tests.question.processingStatus": "处理中...",
      "tests.question.tryAgain": "重试",
      "tests.history.title": "测试记录",
      "tests.history.empty": "暂无测试记录。",
      "tests.next": "下一步",
    },
  },
};
